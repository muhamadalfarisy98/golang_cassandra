...
// implementing CORS (Cross-Origin Resources Sharing )
...
func main() {
	...
	// implementing CORS (Cross-Origin Resources Sharing )
	// because we would like to allow any application to use freely
	//  all the API functions, if these lines are skipped,
	// then none of the applications will use the restful API.
